...
{    
    public static class MouseEventProperties
    {
        ...
        typeof(bool), typeof(MouseEventProperties), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(OnNotifyPropertyChanged)));
        ...
        typeof(bool), typeof(MouseEventProperties), new FrameworkPropertyMetadata(false));
